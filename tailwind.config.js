...
module.exports = {
    ...
    extend: {
      colors: {
        ...
        ink: {
          ...
          'warning-dark':       'var(--color-text-warning-dark)',
          ...
          'on-ship':            'var(--color-text-on-ship)',
        },
  ...
  safelist: [
    ...
    // ── Semantic — surface ────────────────────────────────────────
    { pattern: /^bg-surface-(primary|secondary|tertiary|accent|accent-subtle|accent-contrast|transparent|disable|success|error|warning|info|critical|ship|interactive-hover|interactive-pressed|overlay|backdrop|raised|surbase-dashboard)$/ },
    // ── Semantic — ink ────────────────────────────────────────────
    { pattern: /^text-ink-(primary|secondary|tertiary|disable|accent|on-accent|invert|placeholder|critical|ship|interactive-hover|interactive-pressed|success|error|error-dark|warning|warning-dark|info|on-success|on-error|on-warning|on-info|on-critical|on-ship)$/ },
    // ── Semantic — line ───────────────────────────────────────────
    { pattern: /^border-line-(primary|secondary|accent|disable|focus|error|success|invert|critical|subtle|interactive-hover|warning|info)$/ },
    // ── Semantic — icon ───────────────────────────────────────────
    { pattern: /^(bg|text)-icon-(primary|secondary|tertiary|disable|accent|on-accent|invert|critical|ship|success|error|warning|info)$/ },
